...
function EstateStep04({ history ,onChangeData ,detailStepData , onClickSetDataSale ,onChangePrevStep}){
  return (
    <WhiteBox>
      <strong className="inner-tit">4. 매도인 정보</strong>
      <ul className="row-table">
        <li>
          <strong className="row-tit">주소</strong>
          <div className="row-wrap">
            <Input name={'sellerAddress'} value={detailStepData.sellerAddress.value} onChange={onChangeData} ph="주소 입력" />
          </div>
        </li>
        <li>
          <strong className="row-tit">사업자번호</strong>
          <div className="row-wrap">
            <Input width={'calc(50% - 10px)'} name={'sellerBusinessNumber'} value={detailStepData.sellerBusinessNumber.value} onChange={onChangeData} ph="사업자번호 입력" />
          </div>
        </li>
        <li>
          <strong className="row-tit">법인(주민)등록번호</strong>
          <div className="row-wrap">
            <Input width={'calc(50% - 10px)'} name={'sellerCorporationNumber'} value={detailStepData.sellerCorporationNumber.value} onChange={onChangeData} ph="법인(주민)등록번호 입력" />
          </div>
        </li>
        <li>
          <strong className="row-tit">전화번호</strong>
          <div className="row-wrap">
            <Input width={'calc(50% - 10px)'} name={'sellerPhoneNumber'} value={detailStepData.sellerPhoneNumber.value} onChange={onChangeData} ph="전화번호 입력" />
          </div>
        </li>
        <li>
          <strong className="row-tit">휴대전화번호</strong>
          <div className="row-wrap">
            <Input width={'calc(50% - 10px)'} name={'sellerMobilePhoneNumber'} value={detailStepData.sellerMobilePhoneNumber.value} onChange={onChangeData} ph="휴대전화번호 입력" />
          </div>
        </li>
        <li>
          <strong className="row-tit">팩스</strong>
          <div className="row-wrap">
            <Input width={'calc(50% - 10px)'} name={'sellerFaxNumber'} value={detailStepData.sellerFaxNumber.value} onChange={onChangeData} ph="팩스 입력" />
          </div>
        </li>
        <li>
          <strong className="row-tit">상호</strong>
          <div className="row-wrap">
            <Input name={'sellerName'} value={detailStepData.sellerName.value} onChange={onChangeData} ph="상호 입력" />
          </div>
        </li>
        <li>
          <strong className="row-tit">대표자명</strong>
          <div className="row-wrap">
            <Input width={'calc(50% - 10px)'} name={'sellerSRepresentativeName'} value={detailStepData.sellerSRepresentativeName.value} onChange={onChangeData} ph="대표자명 입력" />
          </div>
        </li>
        <li>
      ...
      <ButtonGroup>
          ...
          <div className="right-btn">
              ...
              <Button text={'DB입력'} size={'small'} bgColor={'#2b72ae'} color={'#fff'} onClick={onClickSetDataSale} />
          </div>
        </ButtonGroup>
    </WhiteBox>
  )
...
export default withRouter(EstateStep04);
