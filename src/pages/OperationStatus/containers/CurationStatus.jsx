...
import { ColumnsTop} from '../components/CurationColumns';




class CurationStatus extends Component {
  constructor(props) {
    super(props);
    this.state = {
      pageDepth : [2,1,2],
  ...
  render() {
    const {pageDepth , userName , pageRange ,isLoad ,params ,searchData ,contractData} = this.state;
    const RowColumns = [
      {
        title:'조회기간',
...
export default withRouter(CurationStatus);
