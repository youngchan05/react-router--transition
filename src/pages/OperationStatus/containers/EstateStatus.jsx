...
import EstateStatusColumns from '../components/EstateStatusColumns';




class EstateStatus extends Component {
  constructor(props) {
    super(props);
    this.state = {
      pageDepth : [2,0,3],
  ...
  render() {
    ...
    return (
      ...
      <WhiteBox>
        ...
        <WhiteBox>
          <Table columns={EstateStatusColumns} rows={contractData} params={params}onClickSort={this.onClickSort} getDetailPage={this.getDetailPage} onClickCheck={this.onClickCheck}/>     
...
export default withRouter(EstateStatus);
